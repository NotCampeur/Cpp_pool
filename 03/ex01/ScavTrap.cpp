...
/*   Updated: 2021/05/05 18:14:16 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// CONSTRUCTORS | DESTRUCTOR
			...
			ScavTrap::ScavTrap()
	: _Name("ScavTrap"), _Lvl(1), _MaxHP(100), _HP(100), _MaxEP(50), _EP(50)
	, _MeleeDamage(20), _RangedDamage(15), _ArmorAmount(0)
{
}

			ScavTrap::ScavTrap(std::string const &name)
	: _Name(name), _Lvl(1), _MaxHP(100), _HP(100), _MaxEP(50), _EP(50)
	, _MeleeDamage(20), _RangedDamage(15), _ArmorAmount(0)
{
...
std::string	ScavTrap::Name(void) const
{
	return _Name;
}

int			ScavTrap::Lvl(void) const
{
	return _Lvl;
}

int			ScavTrap::MaxHP(void) const
{
	return _MaxHP;
}

int			ScavTrap::HP(void) const
{
	return _HP;
}

int			ScavTrap::MaxEP(void) const
{
	return _MaxEP;
}

int			ScavTrap::EP(void) const
{
	return _EP;
}

int			ScavTrap::MeleeDamage(void) const
{
	return _MeleeDamage;
}

int			ScavTrap::RangedDamage(void) const
{
	return _RangedDamage;
}

int			ScavTrap::ArmorAmount(void) const
{
	return _ArmorAmount;
}
...
void		ScavTrap::setMaxHP(int value)
{
	_MaxHP = value;
}
...
void		ScavTrap::setMaxEP(int value)
{
	_MaxEP = value;
}

void		ScavTrap::setEP(int value)
{
	_EP = value;
}

void		ScavTrap::setMeleeDamage(int value)
{
	_MeleeDamage = value;
}

void		ScavTrap::setRangedDamage(int value)
{
	_RangedDamage = value;
}

void		ScavTrap::setArmorAmount(int value)
{
	_ArmorAmount = value;
}
...
void		ScavTrap::printLvl(void) const
{
	std::cout << _Lvl << std::endl;
}

void		ScavTrap::printMaxHP(void) const
{
	std::cout << _MaxHP << std::endl;
}

void		ScavTrap::printHP(void) const
{
	std::cout << _HP << std::endl;
}

void		ScavTrap::printMaxEP(void) const
{
	std::cout << _MaxEP << std::endl;
}

void		ScavTrap::printEP(void) const
{
	std::cout << _EP << std::endl;
}

void		ScavTrap::printMeleeDamage(void) const
{
	std::cout << _MeleeDamage << std::endl;
}

void		ScavTrap::printRangedDamage(void) const
{
	std::cout << _RangedDamage << std::endl;
}

void		ScavTrap::printArmorAmount(void) const
{
